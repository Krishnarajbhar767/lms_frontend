...
const Button: React.FC<ButtonProps> = ({
    ...
    const baseStyle =
        "px-4 py-2 rounded-lg font-medium transition-all focus:outline-none focus:ring-2 cursor-pointer";

    const variantStyles: Record<ButtonVariant, string> = {
        primary:
            "bg-yellow-50 text-richblack-900 hover:bg-yellow-100 focus:ring-yellow-50 text-richblack-900 font-semibold",
        secondary:
        ...
        outline:
            "border border-white text-white hover:bg-richblack-800 hover:text-white focus:ring-yellow-50 focus:border-none",
